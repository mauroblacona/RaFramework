...
RA_ENABLE_ADMIN_DELETE_ALL = True
RA_ADMIN_INDEX_PAGE = 'index.html'
RA_ADMIN_SITE_TITLE = 'SmartGym'
RA_ADMIN_SITE_HEADER = 'Administration'
RA_ADMIN_INDEX_TITLE = 'Estadisticas'